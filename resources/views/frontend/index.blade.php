      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('frontend/assets/img/logistics-service.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('frontend/assets/img/cargo-service.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('frontend/assets/img/trucking-service.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('frontend/assets/img/packaging-service.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('frontend/assets/img/warehousing-service.jpg')}}" alt="" class="img-fluid">
              </div>
